...
export function CobrosView({ records: initialRecords = [] }: CobrosViewProps) {
  ...
  const handleViewReceipt = (record: BillingRecord) => {
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Supervisión de estados de pago, métodos activos y emisión de comprobantes
            </p>
          </div>
                        ...
                        <div className="flex justify-end items-center gap-1">
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-44">
                              ...
                              <DropdownMenuItem onClick={() => handleViewReceipt(r)} className="cursor-pointer gap-2">
              ...
              <div className="border rounded-lg p-4 bg-muted/20 space-y-3">
                <div className="flex justify-between items-start border-b pb-3">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-[10px] text-muted-foreground mt-1">Fecha: {formatDate(new Date())}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 text-xs py-1">
                  ...
                  <div className="text-right">
                    <span className="text-muted-foreground block text-[10px]">ESTADO SUSCRIPCIÓN:</span>
                    <span className="font-semibold text-emerald-600">Servicio Activo</span>
                    <span className="block text-muted-foreground text-[11px]">Vto: {formatDate(selectedReceipt.fechaProximoVencimiento)}</span>
                  </div>
                </div>
